...
<section id="ocurso">
	...
	<div class="container-full-ese detalhe-curso">
...
<section id="vestibular-curso">
	<div class="container-ese display-flex between">
		...
		<div class="col display-flex column centralizado">
...
<section id="matriz-curso">
	...
	<div class="container-ese">
		...
		<div class="separador-p" style="margin-bottom: 42px;"></div>
			...
			<?php get_template_part('template_parts/matriz-curricular'); ?>
	</div>
</div>
</div>
</section>
...
<section id="professores-curso">
	<div class="container-full-ese">
		<div class="container-ese display-flex column">
...
<section id="vestibular-datas" style="background: #061727 url('<?php echo get_sub_field('imagem_de_fundo'); ?>') no-repeat;">
		...
		<div class="container-ese">
			<div class="col-vestibular-100">
				...
				<div class="box-vestibular-aberto">
					...
					<div class="container-full-ese display-flex centralizado" style="margin: 5% 0;">
						<div class="btn-vestibular-aberto acesse-edital"><a href="">Acesse o edital</a></div>
						<div class="btn-vestibular-aberto inscreva-se-vestibular"><a href="">Quero me Inscrever</a></div>
					</div>
				</div>
			<?php 	} else { ?>
						<div class="right-col-vestibular">
							<div class="box-form display-flex column centralizado">
	...
	<div class="container-full-ese" style="margin: 250px 0 0;">
		<div class="container-ese">
			...
			<?php echo get_sub_field('info_vestibular_1'); ?>
			</div>
			...
			<div class="col-vestibular">
				<?php echo get_sub_field('info_vestibular_2'); ?>
			</div>
		</div>
	</div>
</section>
